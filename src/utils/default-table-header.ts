...
export const ISSUE_TEMPLATE_LIST = new Set(['name', 'platform', 'description', 'createTime', 'updateTime'])
export const CUSTOM_TABLE_HEADER: { [key: string]: any } = {
  CUSTOM_FIELD: [
  ...
  TEST_PLAN_LIST: [
    ...
    {
      id: 'testPlanApiScenarioCount',
      key: 'i',
      label: 'test_track.plan.test_plan_api_scenario_count'
    },
