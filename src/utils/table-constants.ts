...
export function CUSTOM_FIELD_TYPE_FILTERS() {
  return [
    { value: 'input', text: i18n.global.t('workspace.custom_filed.input') },
    { value: 'textarea', text: i18n.global.t('workspace.custom_filed.textarea') },
    { value: 'select', text: i18n.global.t('workspace.custom_filed.select') },
    { value: 'multipleSelect', text: i18n.global.t('workspace.custom_filed.multipleSelect') },
    { value: 'radio', text: i18n.global.t('workspace.custom_filed.radio') },
    { value: 'checkbox', text: i18n.global.t('workspace.custom_filed.checkbox') },
    { value: 'member', text: i18n.global.t('workspace.custom_filed.member') },
    { value: 'multipleMember', text: i18n.global.t('workspace.custom_filed.multipleMember') },
    { value: 'date', text: i18n.global.t('workspace.custom_filed.date') },
    { value: 'datetime', text: i18n.global.t('workspace.custom_filed.datetime') },
    { value: 'richText', text: i18n.global.t('workspace.custom_filed.richText') },
    { value: 'int', text: i18n.global.t('workspace.custom_filed.int') },
    { value: 'float', text: i18n.global.t('workspace.custom_filed.float') },
    { value: 'multipleInput', text: i18n.global.t('workspace.custom_filed.multipleInput') }
  ]
}
...
export function CASE_TYPE_OPTION() {
  return [
    {
      value: 'functional',
      text: i18n.global.t('api_test.home_page.failed_case_list.table_value.case_type.functional')
    }
  ]
}
...
export const ISSUE_STATUS_MAP: { [key: string]: string } = {
  new: i18n.global.t('test_track.issue.status_new'),
  closed: i18n.global.t('test_track.issue.status_closed'),
  resolved: i18n.global.t('test_track.issue.status_resolved'),
  active: i18n.global.t('test_track.issue.status_active'),
  delete: i18n.global.t('test_track.issue.status_delete'),
  created: i18n.global.t('test_track.issue.status_new')
}

export const TAPD_ISSUE_STATUS_MAP = {
  new: i18n.global.t('test_track.issue.tapd_status_new'),
  in_progress: i18n.global.t('test_track.issue.tapd_status_in_progress'),
  reopened: i18n.global.t('test_track.issue.tapd_status_reopened'),
  rejected: i18n.global.t('test_track.issue.tapd_status_rejected'),
  verified: i18n.global.t('test_track.issue.tapd_status_verified'),
  closed: i18n.global.t('test_track.issue.tapd_status_closed'),
  resolved: i18n.global.t('test_track.issue.tapd_status_resolved')
}

export function API_SCENARIO_FILTERS() {
  return {
    STATUS_FILTERS: [
      { text: i18n.global.t('test_track.plan.plan_status_prepare'), value: 'Prepare' },
      { text: i18n.global.t('test_track.plan.plan_status_running'), value: 'Underway' },
      { text: i18n.global.t('test_track.plan.plan_status_completed'), value: 'Completed' }
    ],
    TRASH_FILTERS: [{ text: i18n.global.t('test_track.plan.plan_status_trash'), value: 'Trash' }],
    ...
    RESULT_FILTERS: [
      { text: i18n.global.t('api_test.automation.fail'), value: 'Fail' },
      { text: i18n.global.t('api_test.automation.success'), value: 'Success' }
    ]
  }
  /* LEVEL_FILTERS: [
    {text: 'P0', value: 'P0'},
  ...
  /* STATUS_FILTERS: [
    ...
    {text: i18n.global.t('test_track.plan.plan_status_running'), value: 'Underway'},
    {text: i18n.global.t('test_track.plan.plan_status_completed'), value: 'Completed'},
    {text: i18n.global.t('test_track.plan.plan_status_trash'), value: 'Trash'},
  ], */
}
